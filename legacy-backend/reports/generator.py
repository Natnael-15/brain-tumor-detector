...
class ReportGenerator:
    ...
    def _create_html_content(self, data: Dict) -> str:
        ...
        <body>
            <div class="header">
                <div class="hospital-name">AI Medical Imaging Center</div>
            ...
            <div class="footer">
                <p><strong>Disclaimer:</strong> This report is generated by an AI system and is intended for research purposes only. 
                Clinical decisions should always be made by qualified medical professionals after thorough review of all available data.</p>
    ...
    def generate_text_report(self, analysis_data: Dict, output_path: str):
        ...
        content.append("This report is generated by an AI system for research purposes only.")
        content.append("Clinical decisions should be made by qualified medical professionals.")
